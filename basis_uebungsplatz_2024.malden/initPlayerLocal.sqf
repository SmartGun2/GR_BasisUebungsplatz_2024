...
_tp_menu = ["Schnellreise","Schnellreise","","",_condition] call ace_interact_menu_fnc_createAction;
[(typeOf player), 1, ["ACE_SelfActions"], _tp_menu] call ace_interact_menu_fnc_addActionToClass;

_tp_sr75 = ["Schießbahn 75m","Schießbahn 75","",{ player setPos [7265.18,10459.6,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_sr150 = ["Schießbahn 150m","Schießbahn 150","",{ player setPos [7485.58,10579.1,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_srLR = ["Schießbahn LR","Schießbahn LR","",{ player setPos [6703.17,10907.8,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_srMortar = ["Artillerie","Artillerie","",{ player setPos [6286.1,10805.9,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_cqb = ["CQB Dorf","CQB Dorf","",{ player setPos [7574.56,10645.1,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_ausbildung = ["Ausbildungszentrum","Ausbildungszentrum","",{ player setPos [8110.54,10012.5,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_sani = ["Sanitätszentrum","Sanitätszentrum","",{ player setPos [8283.45,10067.2,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_lima = ["Lima Hangar","Lima Hangar","",{ player setPos [8100.95,10476.4,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_flughafen = ["Flughafen","Flughafen","",{ player setPos [8089.8,10088.9,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_parkour = ["Hindernisparkour","Hindernisparkour","",{ player setPos [8262.76,10236.6,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_fahrzeug = ["Fahrtraining","Fahrtraining","",{ player setPos [6304.23,10666.3,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_combined1 = ["Combined Arms Areal","Combined Arms Areal","",{ player setPos [5611.57,11182.7,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_combined2 = ["Combined Arms Fuhrpark","Combined Arms Fuhrpark","",{ player setPos [5926.93,10741.1,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_minen = ["Minenfeld","Minenfeld","",{ player setPos [7499.37,10771.5,0] },_condition] call ace_interact_menu_fnc_createAction;
_tp_marine = ["Marinehafen","Marinehafen","",{ player setPos [8472.46,3779.5,0] },_condition] call ace_interact_menu_fnc_createAction;

[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_sr75] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_sr150] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_srLR] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_srMortar] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_cqb] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_ausbildung] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_sani] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_lima] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_flughafen] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_parkour] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_fahrzeug] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_combined1] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_combined2] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_minen] call ace_interact_menu_fnc_addActionToClass;
[(typeOf player), 1, ["ACE_SelfActions","Schnellreise"], _tp_marine] call ace_interact_menu_fnc_addActionToClass;
